            ...
            {uniqueCategories.map((cat) => (
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium border transition ${
                  category === cat ? "bg-[#83b735] text-white border-[#83b735]" : "bg-white text-gray-700 border-gray-300 hover:bg-gray-100"
                }`}
              >
                {cat}
              </button>
            ...
            {Array.from({ length: totalPages }, (_, i) => (
              <button
                ...
                className={`w-9 h-9 rounded-full text-sm font-medium border ${
                  currentPage === i + 1 ? "bg-[#83b735] text-white border-[#83b735]" : "bg-white text-black border-gray-300"
                }`}
              >
                {i + 1}
              </button>
